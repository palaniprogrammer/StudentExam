...
public partial class Default2 : System.Web.UI.Page
{
    ...
    SqlConnection conn = new SqlConnection(@"Data Source=LKB-L-071\SQLEXPRESS;Initial Catalog=OnlineExam;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    ...
    {
        conn.Open();
        SqlCommand cmd = new SqlCommand("select * from tblQuestions", conn);
        //cmd.ExecuteReader();
        //SqlDataAdapter adp = new SqlDataAdapter(cmd);
         SqlDataAdapter adp = new SqlDataAdapter("select * from tblQuestions", conn);
        adp.Fill(dt);
